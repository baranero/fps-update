          ...
          <div className="w-full px-4 lg:w-1/2">
            ...
            >
              <Image
                ...
                alt="cfd"
                fill
                className="drop-shadow-three dark:hidden dark:drop-shadow-none object-contain rounded-md"
              />
              <Image
                src="/images/cfd.png"
                alt="cfd"
                fill
                className="drop-shadow-three hidden dark:block dark:drop-shadow-none object-contain rounded-md"
              />
            </div>
          </div>
          <div className="w-full px-4 lg:w-1/2">
