...
// Sekcje ofertowe („co dostaniesz" + FAQ) — wspólne dla publicznego landingu
// (anonim / brak dostępu) oraz kroku „upload" kreatora, żeby nie dublować treści.
function CloudMarketing() {
