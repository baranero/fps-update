...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://fp-solutions.pl/blog/norma-02877",
  },
  openGraph: {
    ...
    url: "https://fp-solutions.pl/blog/norma-02877",
  },
};
            ...
            <div className="w-full px-4 lg:w-8/12">
              <article>
                <h1 className="mb-8 text-3xl font-bold leading-tight text-slate-900 dark:text-white sm:text-4xl sm:leading-tight">
                  Zmiany w projektowaniu systemów oddymiania: Analiza nowej normy PN-B-02877-4:2025-07
                </h1>
                      ...
                      <div className="mr-4">
                        <div className="relative h-10 w-10 overflow-hidden rounded-full">
                          <Image
                            ...
                            alt="Jakub Baran - inżynier bezpieczeństwa pożarowego"
                            fill
                ...
                <div>
                  ...
                  <h3 className="mb-6 text-xl font-bold text-slate-900 dark:text-white sm:text-2xl lg:text-xl xl:text-2xl">
                  ...
                  <p className="mb-8 text-base font-medium leading-relaxed text-slate-600 sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
                    ...
                    wynosi obecnie <strong className="text-slate-900 dark:text-white">4 000 m²</strong>. Dokument dopuszcza wręcz
                  ...
                  <p className="mb-8 text-base font-medium leading-relaxed text-slate-600 sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
                    ...
                    podstawie przypisania strefy do jednej z pięciu <strong className="text-slate-900 dark:text-white">Grup Projektowych (GP1 - GP5)</strong>.
                  ...
                  <div className="relative z-10 mb-10 overflow-hidden rounded-md bg-primary/10 p-8 md:p-9 lg:p-8 xl:p-9">
                    ...
                    <span className="absolute left-0 top-0 z-[-1]">
                      <svg width="132" height="109" viewBox="0 0 132 109" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <defs>
                          <linearGradient id="paint0_linear_111:606" x1="94.7523" y1="82.0246" x2="8.40951" y2="52.0609" gradientUnits="userSpaceOnUse"><stop stopColor="white" stopOpacity="0.06" /><stop offset="1" stopColor="white" stopOpacity="0" /></linearGradient>
                          <linearGradient id="paint1_linear_111:606" x1="90.3206" y1="58.4236" x2="1.16149" y2="50.8365" gradientUnits="userSpaceOnUse"><stop stopColor="white" stopOpacity="0.06" /><stop offset="1" stopColor="white" stopOpacity="0" /></linearGradient>
                        </defs>
                      </svg>
                    </span>
                    <span className="absolute bottom-0 right-0 z-[-1]">
                      <svg width="53" height="30" viewBox="0 0 53 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <circle opacity="0.8" cx="37.5" cy="37.5" r="37.5" fill="#DC3545" />
                  ...
                  <div className="items-center justify-between sm:flex">
                    <div className="mb-5">
                      ...
                      <div className="flex flex-wrap items-center gap-2">
                        <TagButton text="Normy" />
                        <TagButton text="Oddymianie" />
                        <TagButton text="PN-B-02877" />
                      </div>
                    </div>
                  </div>
