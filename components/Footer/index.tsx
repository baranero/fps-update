    ...
    <>
      ...
      >
                    ...
                    >
                      <path d="M15.2196 0H1.99991C1.37516 0 0.875366 0.497491 0.875366 1.11936V14.3029C0.875366 14.8999 1.37516 15.4222 1.99991 15.4222H15.1696C15.7943 15.4222 16.2941 14.9247 16.2941 14.3029V1.09448C16.3441 0.497491 15.8443 0 15.2196 0ZM5.44852 13.1089H3.17444V5.7709H5.44852V13.1089ZM4.29899 4.75104C3.54929 4.75104 2.97452 4.15405 2.97452 3.43269C2.97452 2.71133 3.57428 2.11434 4.29899 2.11434C5.02369 2.11434 5.62345 2.71133 5.62345 3.43269C5.62345 4.15405 5.07367 4.75104 4.29899 4.75104ZM14.07 13.1089H11.796V9.55183C11.796 8.7061 11.771 7.58674 10.5964 7.58674C9.39693 7.58674 9.222 8.53198 9.222 9.47721V13.1089H6.94792V5.7709H9.17202V6.79076H9.19701C9.52188 6.19377 10.2466 5.59678 11.3711 5.59678C13.6952 5.59678 14.12 7.08925 14.12 9.12897V13.1089H14.07Z" />
                          ...
                          <div className="w-full px-4">
                            <div
                              className="wow fadeInUp mb-12 rounded-sm py-11  "
                              data-wow-delay=".15s
                              "
                            >
                ...
                <ul>
                  ...
                  <li>
                    <a
                      ...
                      className="mb-4 inline-block text-base text-body-color duration-300 hover:text-primary dark:text-body-color-dark dark:hover:text-primary"
                    >
                      Projekt systemu oddymiania grawitacyjnego
                    </a>
                  </li>
                  <li>
                    <a
        ...
        <div className="absolute right-0 top-14 z-[-1]">
          ...
          >
            <circle opacity="0.8" cx="49.5" cy="49.5" r="49.5" fill="#DC3545" />
            <mask
              id="mask0_94:899"
          ...
          >
            ...
            <defs>
              <linearGradient
                ...
                gradientUnits="userSpaceOnUse"
              >
                <stop stopColor="#DC3545" stopOpacity="0.62" />
              ...
              >
                ...
                <stop offset="1" stopColor="#DC3545" stopOpacity="0.51" />
              </linearGradient>
              <linearGradient
