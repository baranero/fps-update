...
// Landing serwisu chmurowego FDSRun. Renderowany zarówno jako root projektu
// „cloud" (fdsrun.com/, gdy SITE_MODE=cloud) jak i pod /chmura (dev / alias) —
// jedno źródło treści. Sekcje z istniejących komponentów i kluczy `symulacje.*`.
