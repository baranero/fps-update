...
const NewsLatterBox = () => {
  ...
  return (
    <div
      className="wow fadeInUp shadow-sm dark:bg-[#111827] relative z-10 rounded-2xl bg-white p-8 sm:p-11 lg:p-8 xl:p-11"
      data-wow-delay=".2s"
    >
      <h3 className="mb-4 text-2xl font-bold leading-tight text-slate-900 dark:text-white">
        Subscribe to receive future updates
      </h3>
      <p className="mb-11 border-b border-slate-200  pb-11 text-base leading-relaxed text-slate-600 dark:border-white dark:">
      ...
      <div>
        <input
          ...
          className="border-slate-200 dark:text-slate-400 dark:shadow-sm mb-4 w-full rounded-xl border bg-[#f8f8f8] px-6 py-3 text-base text-slate-600 outline-none focus:border-primary dark:border-transparent dark:bg-slate-800 dark:focus:border-primary dark:focus:shadow-none"
        />
        <input
          type="email"
          name="email"
        ...
        />
        <p className="dark:text-slate-400 text-center text-base leading-relaxed text-slate-600">
