const PricingBox = (props: {
  ...
  return (
    <div className="w-full">
      <div
        className="wow fadeInUp shadow-sm dark:bg-[#111827] dark:shadow-sm dark:hover:shadow-gray-dark relative z-10 rounded-2xl bg-white px-8 py-10 hover:shadow-sm"
        data-wow-delay=".1s"
      >
        <div className="flex items-center justify-between">
          <h3 className="price mb-2 text-3xl font-bold text-slate-900 dark:text-white">
            $<span className="amount">{price}</span>
            <span className="time text-slate-600">/{duration}</span>
          </h3>
        ...
        <div className="mb-8 border-b border-slate-200 border-opacity-10 pb-8 dark:border-slate-700">
