...
const Breadcrumb = ({
  ...
  return (
    <>
      <section className="relative z-10 overflow-hidden pt-44 lg:pt-40">
        <div className="container">
          <div className="-mx-4 flex flex-wrap items-center">
            <div className="w-full px-4 md:w-8/12 lg:w-7/12">
              <div className="mb-8 max-w-[570px] md:mb-0 lg:mb-12">
                {/* Przywrócono H1 - kluczowe dla pozycjonowania podstron */}
        ...
        {/* Elementy dekoracyjne tła z zachowaniem Twojego koloru brandingowego #DC3545 */}
